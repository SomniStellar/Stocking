export function EditIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill="none">
      ...
      <path d="m14 6 4 4 2-2-4-4-2 2Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  )
}
...
export function DeleteIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill="none">
      ...
      <path d="M9 7V5h6v2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="m7 7 1 12h8l1-12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
...
export function ResetIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill="none">
      <path d="M5 12a7 7 0 1 0 2.05-4.95L5 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
